...
export const ACTIVITIES_MAP: Record<string, ActivityOption> = {
  ...
  walk_slow: {
    id: "walk_slow",
    name: "🚶 Легкая ходьба / разминка (до 5.5 км/ч)",
    category: "Ходьба/Бег",
    met: 3.3,
  },
  walk_fast: {
  ...
  run_medium: {
    id: "run_medium",
    name: "🏃 Бег средней интенсивности (10 км/ч)",
    category: "Ходьба/Бег",
    met: 9.8,
  },
  run_fast: {
  ...
  strength_normal: {
    id: "strength_normal",
    name: "🏋️ Силовая тренировка (с отдыхами между подходами)",
  ...
  bike_light: {
    id: "bike_light",
    name: "🚴 Легкая езда / Прогулка (до 15 км/ч)",
    category: "Велосипед",
    met: 4.0,
  },
  bike_hard: {
    id: "bike_hard",
    name: "🚴 Интенсивный сайклинг / Велоспорт (15-20 км/ч)",
    category: "Велосипед",
    met: 6.8,
  },
  ...
  swim_normal: {
    id: "swim_normal",
    name: "🏊 Плавание в среднем темпе (оздоровительное)",
    category: "Плавание",
    met: 5.8,
  },
  swim_hard: {
    id: "swim_hard",
    name: "🏊 Интенсивное плавание на скорость",
    category: "Плавание",
    met: 9.8,
  },
